...
export function CharacterBuilder() {
  ...
  return <section className="start-flow" aria-labelledby="builder-title"><div className="progress-steps" aria-label="Campaign creation progress"><span>✓ Story</span><strong>2 · Hero</strong><span>3 · Enter world</span></div><div className="start-hero"><span className="eyebrow">CHARACTER CREATION · STEP 2 OF 3</span><h1 id="builder-title">Who answers Glass Harbor?</h1><p>Start with identity and intent. The Build Point ledger makes every mechanical tradeoff visible.</p></div>
